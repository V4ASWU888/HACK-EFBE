...
def login():
    ...
    try:
        ...
        print '\x1b[1;91m[\xe2\x98\x86] \x1b[1;92m(1)LOGIN TOKEN FACEBOOK \x1b[1;91m[\xe2\x98\x86]'
        id = raw_input('\x1b[1;91m[+] \x1b[1;36mU(2)LOGIN COOKIES FB \x1b[1;91m:\x1b[1;92m ')
        pwd = getpass.getpass('\x1b[1;91m[+] \x1b[1;36m(3)exit/logout \x1b[1;91m:\x1b[1;92m ')
        tik()
        try:
            br.open('https://m.facebook.com')
        except mechanize.URLError:
            print '\n\x1b[1;91m[!] Masukan Token FB"
            token invalid()
...
def menu():
    ...
    try:
        ...
        try:
            ...
            os.system('clear')
            print '\x1b[1;91m[!] \x1b[1;93mLOGIN BERhasil '
            os.system('rm -rf login.txt')
            time.sleep(1)
            login()
        except requests.exceptions.ConnectionError:
            print '\x1b[1;91m[!] Masukan ulang token'
